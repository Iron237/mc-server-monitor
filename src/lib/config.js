...
function loadAppConfig(rootDir) {
  return {
    ...
    sparkPingProbeIntervalMs: Math.max(15_000, envInt("SPARK_PING_PROBE_MS", 60_000)),
    sparkPingMaxAgeMs: Math.max(60_000, envInt("SPARK_PING_MAX_AGE_MS", 5 * 60 * 1000)),
    msptWindowMs: Math.max(60_000, envInt("MSPT_WINDOW_MS", 15 * 60 * 1000)),
